...
void GameObj::Update(DWORD dt, vector<LPGAMEOBJ>* coObjects)
{
	this->dt = dt;
	dx = vx * dt;
	dy = vy * dt;
...
*/
LPCOLLISIONEVENT GameObj::SweptAABBEx(LPGAMEOBJ coO)
{
